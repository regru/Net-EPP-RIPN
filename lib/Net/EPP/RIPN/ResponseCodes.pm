package Net::EPP::RIPN::ResponseCodes;
...
Net::EPP::RIPN::ResponseCodes - a module to export some constants that
...
=head1 SYNOPSIS
    ...
    if ($result) {
        ...
        if ($Net::EPP::RIPN::Simple::Code == OBJECT_PENDING_TRANSFER) {
            print "Error: domain is already pending transfer\n";

        } elsif ($Net::EPP::RIPN::Simple::Code == INVALID_AUTH_INFO) {
            print "Error: invalid authcode provided\n";

        } elsif ($Net::EPP::RIPN::Simple::Code == OBJECT_DOES_NOT_EXIST) {
            print "Error: domain not found\n";

        } elsif ($Net::EPP::RIPN::Simple::Code == STATUS_PROHIBITS_OP) {
            print "Error: domain cannot be transferred\n";

        } else {
            print "Error code $Net::EPP::RIPN::Simple::Code\n";
...
C<Net::EPP::RIPN::ResponseCodes> exports the following constants. The number in
...
=item  INTERNAL_SERVER_ERROR (2401)
...
use constant INTERNAL_SERVER_ERROR => 2401;
