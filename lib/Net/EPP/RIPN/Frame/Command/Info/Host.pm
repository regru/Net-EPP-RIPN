package Net::EPP::RIPN::Frame::Command::Info::Host;
...
Net::EPP::RIPN::Frame::Command::Info::Host - an instance of L<Net::EPP::RIPN::Frame::Command::Info>
for host objects.
...
=head1 SYNOPSIS
        ...
        my $info = Net::EPP::RIPN::Frame::Command::Info::Host->new;
        ...
        +----L<Net::EPP::RIPN::Frame>
            +----L<Net::EPP::RIPN::Frame::Command>
                +----L<Net::EPP::RIPN::Frame::Command::Info>
                    +----L<Net::EPP::RIPN::Frame::Command::Info::Host>
...
sub new {
        ...
        my $host = $self->addObject(Net::EPP::RIPN::Frame::ObjectSpec->spec('host'));
