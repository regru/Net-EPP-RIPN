package Net::EPP::RIPN::Frame::Command::Info::Contact;
...
Net::EPP::RIPN::Frame::Command::Info::Contact - an instance of L<Net::EPP::RIPN::Frame::Command::Info>
for contact objects.
...
=head1 SYNOPSIS
        ...
        my $info = Net::EPP::RIPN::Frame::Command::Info::Contact->new;
        ...
        +----L<Net::EPP::RIPN::Frame>
            +----L<Net::EPP::RIPN::Frame::Command>
                +----L<Net::EPP::RIPN::Frame::Command::Info>
                    +----L<Net::EPP::RIPN::Frame::Command::Info::Contact>
...
sub new {
        ...
        my $contact = $self->addObject(Net::EPP::RIPN::Frame::ObjectSpec->spec('contact'));
